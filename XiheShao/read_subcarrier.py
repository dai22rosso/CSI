...
for No in range(0, 50):
    # make new folder
    os.mkdir("C:\\Users\\rossoneri\\Desktop\\DIFFERENT_PHASE\\wave" + three_bit(No))

    dir_ = 'C:\\Users\\rossoneri\\Desktop\\DIFFERENT_PHASE\\tdx_wave_0726\\wave_csv_' + three_bit(No) + '/'
    ...
    for txid in range(Num_Tx):
        ...
        for scid in range(Num_Sc):
            ...
            np.savetxt("C:\\Users\\rossoneri\\Desktop\\DIFFERENT_PHASE\\wave" + three_bit(No) + "\\" + txt_name, subcarrier_diff_phase, fmt='%.8f')
